...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C0NFgtdT.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-n-Fm4Ts5.js").then((n) => n.r),
    import("./start-CUQS70Df.js"),
...
var ROUTER_BASEPATH = "Jushita-Pediredla-E-Portfolio";
var SERVER_FN_BASE = "/Jushita-Pediredla-E-Portfolio/_serverFn/";
